...
// image default alt
if ( ! function_exists( 'leopet_img_default_alt' ) ) {
	function leopet_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'leopet_img_tag' ) ) {
	function leopet_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = leopet_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'leopet_anchor_tag' ) ) {
	function leopet_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'leopet_heading_tag' ) ) {
	function leopet_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'leopet_paragraph_tag' ) ) {
	function leopet_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'leopet_other_tag' ) ) {
	function leopet_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'leopet_button_element ' ) ) {
	function leopet_button_element( array $args ) {
